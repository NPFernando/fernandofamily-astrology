...
from app.modules.muhurta.models import MuhurtaMonthResponse, MuhurtaSearchResponse
...
@router.post("/month", response_model=MuhurtaMonthResponse, dependencies=[Depends(enforce_rate_limit)])
def month(body: MuhurtaMonthRequest) -> MuhurtaMonthResponse:
    return service.month(body, _engine_metadata())
