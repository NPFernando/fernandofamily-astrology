...
class _MuhurtaMonthBase(BaseModel):
...
class MuhurtaMonthBirthDateTimeInput(_MuhurtaMonthBase):
    method: Literal["birth_datetime"]
    birth_date: date_type
    birth_time: time_type


class MuhurtaMonthNakshatraPakshaInput(_MuhurtaMonthBase):
    method: Literal["nakshatra_paksha"]
    nakshatra_index: int
    paksha: PakshaId


class MuhurtaMonthBirdSelectionInput(_MuhurtaMonthBase):
    method: Literal["bird"]
    bird: BirdId
